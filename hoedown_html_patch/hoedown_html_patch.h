...
const static unsigned int HOEDOWN_HTML_USE_TASK_LIST = (1 << 4);
const static unsigned int HOEDOWN_HTML_BLOCKCODE_LINE_NUMBERS = (1 << 5);
const static unsigned int HOEDOWN_HTML_BLOCKCODE_INFORMATION = (1 << 6);
